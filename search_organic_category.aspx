<%@ Page Title="" Language="C#" MasterPageFile="~/Inside.master" AutoEventWireup="true" CodeFile="search_organic_category.aspx.cs" Inherits="search_organic_category"  Debug="true" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
			...
			$(".various_method").click(function(){
				...
				jQuery.ajax({
					url: '/search_organic_category.aspx/infomethodor',
					type: "POST",
			...
			$(".various_cascon").click(function(){
				var part = $(this).attr('data-partnum');
				jQuery.ajax({
					url: '/search_organic_category.aspx/infoor',
					type: "POST",
					data: JSON.stringify({ partnumber: part }),
					contentType: "application/json; charset=utf-8",
					dataType: "json",

<%@ Page Language="C#" Title="Update Custom Standards Page" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="custom_standards_edit" ValidateRequest="false" debug="true"%>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> Edit Custom Standards Page
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-lg-12">
            <div class="table-responsive">
				...
				<label>Paragraph1:</label>
                    <asp:TextBox ID="paragraph1" runat="server" CssClass="form-control" placeholder="paragraph1" TabIndex="0" Width="100%" TextMode="MultiLine"></asp:TextBox>
                </div>
				...
				<label>Image2 URL:</label>
                    <asp:TextBox ID="image2" runat="server" CssClass="form-control" placeholder="image2" TabIndex="0" Width="20%" ></asp:TextBox>
					<br/>
					<asp:Image ID="image2Con" runat="server" CssClass="banner" />
                </div>
				...
				<div class="form-group" style="width: 100%">
					<label>Long Content2:</label>
                    <asp:TextBox id="long_content2" TextMode="multiline" CssClass="main-editor" Columns="100" Rows="10" runat="server" />
                </div>

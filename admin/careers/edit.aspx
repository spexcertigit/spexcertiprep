            ...
            <div class="row">
				...
				<div class="col-lg-12">
                    <div class="alert alert-success alert-dismissable">
                        ...
                        <strong>Successfully</strong> updated the <strong>Jobs Item!!</strong>
                    </div>
                </div>
				...
				<div class="col-lg-12">
                    <div class="alert alert-danger alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <strong>Opps!</strong> something went wrong in updating the <strong>Jobs Item!!</strong>
                    </div>
                </div>	
				<% }%>
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <i class="fa fa-newspaper-o"></i> <a href="/admin/careers/">Career</a>
                        </li>
                        <li class="active">

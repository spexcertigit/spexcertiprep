...
public partial class career_add : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
		...
		using (SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["SPEXCertiprep"].ConnectionString))
        {
			...
			string SQL = "INSERT INTO [jobs] ([title],[location],[summary],[description],[category],[posteddate],[active]) VALUES ( @title, @location, @summary, @description, @category, @posteddate, @active)";

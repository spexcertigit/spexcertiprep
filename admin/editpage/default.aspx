            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Edit Content <!--<small><input type="button" class="btn btn-primary" onclick="relocate('/admin/editpage/add.aspx')" value="Add New" /></small>-->
                    </h1>
                    <ol class="breadcrumb">
						<li>
                        ...
                        <li class="active">
                            <i class="fa fa-pencil-square-o"></i> Edit Content
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-lg-12">
            <div class="table-responsive">
                <asp:ListView ID="EditPageTable" runat="server">
                    ...
                    <ItemTemplate>
                        <tr id="Tr<%#Eval("PageID") %>">
							
                            <!--<td><%# Regex.Replace(Eval("PageID").ToString(), @"<[^>]+>|&nbsp;", "").Trim() %></td>-->
							<td><a href="/admin/editpage/edit.aspx?id=<%#Eval("PageID") %>" title="Edit"><%#Eval("PageTitle") %></a></td>
							
							<td class="text-center">
								<a href="/admin/editpage/edit.aspx?id=<%#Eval("PageID") %>" title="Edit"><i class="fa fa-edit"></i></a>
								<!--&nbsp;&nbsp;
								<a onclick="confirmation('<%#Eval("PageID") %>')" class="red-del" title="Delete"><i class="fa fa-eraser"></i></a>-->
							</td>

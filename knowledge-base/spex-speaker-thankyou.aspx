<%@ Page Title="SPEX SamplePrep - Thank You" Language="C#" MasterPageFile="~/Inside.master" AutoEventWireup="true" CodeFile="spex-speaker-thankyou.cs" Inherits="thank_you" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBody" Runat="Server">
            <div id="main">
				<div id="mainHeader">
					<h1 style="font-weight:bold;">SPEX CertiPrep <span class="greyHead">SPEX Speaker</span></h1>
				</div>
				<br>
				<h2 style="padding:0">Thank you!</h2>
				<br>
				<p>Thank you for sending your request for a physical copy of our SPEX Speaker Issue.</p>
